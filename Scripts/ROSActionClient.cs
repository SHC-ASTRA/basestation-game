...
// May God have mercy on your soul if you dare try to touch this.
...
namespace IPC
{
    ...
    where E : Message where F : Message where G : Message
    {
        ...
        public ROSActionClient(string _ActionName, A _Action, SendActionGoalHandler<B> _SendActionGoal, CancelActionGoalHandler _CancelActionGoal, GoalStatus _GoalStatus, System.Action _FeedbackCallback, System.Action _ResultCallback, System.Action _StatusCallback)
        {
